...
import { IonApp, IonHeader, IonToolbar, IonButtons, IonTitle, IonRouterOutlet, setupIonicReact, IonTabs, IonTabBar, IonTabButton, IonIcon, IonLabel, IonToast, IonMenuButton, IonContent, IonButton } from '@ionic/react';
...
const AppContent: React.FC = () => {
  ...
  const handleLogout = () => {
    logout();
    history.push('/home');
    handleShowToast('Sesión cerrada', 'success');
  };
